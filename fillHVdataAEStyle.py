...
myfile2 = pan.read_csv("/home/ppetkov/cms-rpc-data/glm-imp-training-2017-new-format.csv")


myfile3 = pan.read_csv("/home/ppetkov/cms-rpc-data/glm-imp-training-2018-new-format.csv")
